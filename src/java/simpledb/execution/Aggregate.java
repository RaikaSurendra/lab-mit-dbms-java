...
public class Aggregate extends Operator {
    ...
    public TupleDesc getTupleDesc() {
        Type aggType = Type.INT_TYPE;
        String aggName = nameOfAggregatorOp(aop) + " (" + child.getTupleDesc().getFieldName(afield) + ")";
        if (gfield == Aggregator.NO_GROUPING) {
            return new TupleDesc(new Type[]{aggType}, new String[]{aggName});
        } else {
            return new TupleDesc(
                new Type[]{child.getTupleDesc().getFieldType(gfield), aggType},
